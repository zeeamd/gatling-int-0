...
class BasexxxxxxG2Scenario2 extends Simulation {
...
class xxxxxxG2ScenarioTestV2 extends BasexxxxxxG2Scenario2 {
  setUp(
    scn.inject(
      constantUsersPerSec(1000) during (300 seconds) randomized
